class Meetcal < Formula
  ...
  homepage "https://github.com/meetcal/meetcal-cli-rust"
  version "1.0.0"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/meetcal/meetcal-cli-rust/releases/download/v1.0.0/darwin-arm64.tar.gz"
      sha256 "d61ca36ef5486799414e213a137a4e284ca6641e22a127afa1835925087f9f7f"
    else
      url "https://github.com/meetcal/meetcal-cli-rust/releases/download/v1.0.0/darwin-x64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/meetcal/meetcal-cli-rust/releases/download/v1.0.0/linux-arm64.tar.gz"
      sha256 "efbacb33e7b301fe432c2017e2d473e8872e140c44328e8bb1d1b08e08873b2a"
    else
      url "https://github.com/meetcal/meetcal-cli-rust/releases/download/v1.0.0/linux-x64.tar.gz"
